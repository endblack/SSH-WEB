#!/bin/bash
echo -ne "\n\033[1;32mINFORME O A FRASE\033[1;37m: "
read frase
echo "<!DOCTYPE html>
                ...
                <body class="fundodapagina vertical-layout vertical-menu-modern 1-column  navbar-floating footer-static  menu-collapsed blank-page blank-page" data-open="click" data-menu="vertical-menu-modern" data-col="1-column">
                    ...
                    <div class="auth-wrapper auth-basic px-2">
                        <div class="auth-inner my-2">
                            ...
                            <div class="card mb-0">
                                <div class="card-body">
								<marquee behavior="scroll" onmouseout="this.start();" onmouseover="this.stop();"><b><FONT COLOR="#7367F0"><h5>$frase</h5></b></FONT></marquee>
